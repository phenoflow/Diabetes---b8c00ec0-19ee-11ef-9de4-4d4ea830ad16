...
codes = [{"code":"C101100","system":"readv2"},{"code":"C10FN00","system":"readv2"},{"code":"C10EM00","system":"readv2"},{"code":"C101z00","system":"readv2"},{"code":"C101000","system":"readv2"},{"code":"C10EM11","system":"readv2"},{"code":"C101.00","system":"readv2"},{"code":"250 JK","system":"readv2"},{"code":"250 JA","system":"readv2"}];
REQUIRED_CODES = 1;
